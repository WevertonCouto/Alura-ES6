    ...
    _createClass(NegociacaoController, [{
        ...
        value: function _init() {
            ...
            this._service.lista().then(function (negociacoes) {
                return negociacoes.forEach(function (v) {
                    return _this._listaNegociacoes.adiciona(v);
                });
            }).catch(function (erro) {
        ...
        value: function _importaNegociacoes() {
            ...
            this._service.importa(this._listaNegociacoes._negociacoes, function (negociacoes) {
                negociacoes.forEach(function (negociacao) {
                    _this3._listaNegociacoes.adiciona(negociacao);
                    _this3._mensagem.texto = 'Negociações importadas';
                });
            });
        }
    }, {
