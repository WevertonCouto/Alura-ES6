...
var NegociacaoService = function () {
    ...
    _createClass(NegociacaoService, [{
        ...
        key: 'importa',
        value: function importa(listaAtual, cb) {
            Promise.all([this.obterNegociacoesDaSemana(), this.obterNegociacoesDaSemanaAnterior(), this.obterNegociacoesDaSemanaRetrasada()]).then(function (negociacoes) {
                cb(negociacoes.reduce(function (array1, array) {
                    return array1.concat(array);
                }, []).filter(function (negociacao) {
                    return !listaAtual.some(function (nec) {
                        return JSON.stringify(nec) == JSON.stringify(negociacao);
                    });
                }));
            }).catch(function (erro) {
                console.log(erro);
